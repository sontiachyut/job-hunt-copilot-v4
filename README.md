...
- BA-10 hardening is not fully closed yet: the remaining explicit acceptance gaps are autonomous maintenance workflow or artifacts and richer `jhc-chat` review and control behavior
