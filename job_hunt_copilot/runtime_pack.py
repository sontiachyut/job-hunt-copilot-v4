...
def render_chat_bootstrap(
    ...
    return "\n".join(
        [
            ...
            "2. read the current progress log and ops plan before answering substantive runtime questions",
            "3. inspect canonical control state, open incidents, pending expert review packets, and the relevant DB-backed status snapshot",
            "4. inspect only the artifacts needed for the expert's current question or requested action",
            "",
            "Rules:",
