...
- Open acceptance gap summaries:
  ...
  - `BA10_CHAT_REVIEW_AND_CONTROL`: Chat review and control are still missing deeper expert-guidance workflows (`4` scenarios)
...
| --- | --- | --- | ---: | ---: |
| qa_runtime_pack_regressions | automated | passed | 0 | 0.313 |
| qa_acceptance_reports | automated | passed | 0 | 2.325 |
| qa_supervisor_regressions | automated | passed | 0 | 1.058 |
| qa_runtime_control_regressions | automated | passed | 0 | 12.900 |
| qa_review_surface_regressions | automated | passed | 0 | 0.422 |
