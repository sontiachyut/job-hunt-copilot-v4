...
- Confirmation commands:
  ...
  - `python3.11 -m pytest tests/test_acceptance_traceability.py tests/test_blocker_audit.py tests/test_quality_validation.py` (automated: Keeps the committed BA-10 acceptance and blocker reports plus validation-suite selectors synchronized with repo code, tests, and state references.)
