...
- committed BA-10 quality surfaces under `build-agent/reports/` and `scripts/quality/`, including the acceptance trace matrix, blocker audit, and a reusable automated validation-suite runner for smoke plus hardening regressions
